import { BuildingI, RoomI, UserI, WorkspaceI } from "../interfaces/db-intertface";
...
class IndexedDbService {
    ...
    async openDb() {
        return new Promise<IDBDatabase>((resolve, reject) => {
            ...
            request.onupgradeneeded = (event) => {
                ...
                this.db.createObjectStore(WORKSPACE_STORE_NAME, { keyPath: 'id' });
                this.db.createObjectStore(ROOM_STORE_NAME, { keyPath: 'id' });
                this.db.createObjectStore(BUILDING_STORE_NAME, { keyPath: 'id' });
            };
        });
    }
    ...
    async get(storeName: string, id: number) {
        const db = await this.openDb();
        return new Promise<UserI | WorkspaceI | RoomI | BuildingI>((resolve, reject) => {
